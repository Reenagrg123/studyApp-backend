            ...
            <div class="card-body">
                <form method="post">
                    <div class="form-group">
                        ...
                        <input type="text" name="class" class="form-control" id="exampleFormControlInput1" placeholder="Ex: NCERT BOOKS" value="<?php if(isset($edit)){ echo $editdata['class_name']; }?>" required>
                    </div>
